...
defaults = {
    "Tokenizer": (
     ...
     discriminators.  (Not just Date, but Received and X-From_.)"""
        ...
        (
            ...
            _("Only basic header tokenising"),
            False,
            _(
     ...
     of headers that should be skipped."""
        ...
        (
            "check_octets",
            _("Check application/octet-stream sections"),
            False,
            _(
     ...
     octet_prefix_size."""
        ...
        (
            "octet_prefix_size",
            _("Number of characters of octet stream to process"),
            5,
            _(
     ...
     """
        ...
        (
            "x-lookup_ip",
            _("Generate IP address tokens from hostnames"),
            False,
            _(
     ...
     Requires PyDNS (http://pydns.sourceforge.net/)."""
        ...
        (
            "lookup_ip_cache",
            _("x-lookup_ip cache file location"),
            "",
            _(
     ...
     at start and to which to save that info at exit."""
        ...
        (
            "ocrad_scale",
            _("Scale factor to use with ocrad."),
            2,
            _(
     ...
     are 'ascii', 'iso-8859-9' and 'iso-8859-15'."""
        ...
        (
            "max_image_size",
            _("Max image size to try OCR-ing"),
            100000,
            _(
     ...
     reasons if your corpora are from different sources."""
        ...
        (
            "x-mine_nntp_headers",
            _("Mine NNTP-Posting-Host headers"),
            False,
            _(
     ...
     triggers a skip."""
        ...
        (
            "x-pick_apart_urls",
            _("Extract clues about url structure"),
            False,
            _(
     ...
     user/password elements."""
        ...
        (
            ...
            _("Extract URLs without http:// prefix"),
            False,
            _(
     ...
     instead of just long words."""
        ...
        (
            ...
            _("Replace non-ascii characters"),
            False,
            _(
     ...
     be a strong spam sign."""
        ...
        (
            ...
            _("Reduce Habeas Header Tokens to Single"),
            False,
            _(
    ...
    "URLRetriever": (
        (
            "x-slurp_urls",
            _("Tokenize text content at the end of URLs"),
            False,
            _(
     ...
     for messages that contain only a single URL and no other text."""
        ...
        (
            "x-cache_expiry_days",
            _("Number of days to store URLs in cache"),
            7,
            _(
     ...
     """
        ...
        (
            "x-web_prefix",
            _("Prefix for tokens from web pages"),
            "",
            _(
    ...
    "TestDriver": (
        ...
        (
            ...
            _("Compute best cutoffs from histograms"),
            True,
            _(
     ...
     values to analyze."""
        ...
        (
            ...
            _("Best cutoff false positive weight"),
            10.00,
            _(""""""),
            REAL,
            RESTORE,
        ...
        (
            ...
            _("Best cutoff false negative weight"),
            1.00,
            _(""""""),
            REAL,
            RESTORE,
     ...
     likewise for ham.  The defaults here do not show anything."""
        ...
        (
            ...
            _("Show false negatives"),
            False,
            _(""""""),
            BOOLEAN,
            RESTORE,
        ),
        ("show_unsure", _("Show unsure"), False, _(""""""), BOOLEAN, RESTORE),
        (
            "show_charlimit",
            _("Show character limit"),
            3000,
            _(
     ...
     ignored when save_trained_pickles is false."""
        ...
        (
            "save_histogram_pickles",
            _("Save histogram pickles"),
            False,
            _(
    ...
    "CV Driver": (
        (
            ...
            _("Build each classifier from scratch"),
            False,
            _(
    ...
    "Classifier": (
        (
            "max_discriminators",
            _("Maximum number of extreme words"),
            150,
            _(
     ...
     worked best, so this does not seem to be corpus-dependent."""
        ...
        (
            ...
            _("Minimum probability strength"),
            0.1,
            _(
     ...
     *any* deviation from a uniform distribution, regardless of whether
     ...
     general python.org traffic)."""
        ...
        (
            "use_bigrams",
            _("Use mixed uni/bi-grams scheme"),
            False,
            _(
    ...
    "Storage": (
     ...
     most recent configuration file loaded."""
        ...
        (
            ...
            _("Message information file name"),
            DB_TYPE[2],
            _(
     ...
     of the most recent configuration file loaded."""
        ...
        (
            "cache_expiry_days",
            _("Days before cached messages expire"),
            7,
            _(
     ...
     with the filtering that Spambayes is doing for you."""
        ...
        (
            "no_cache_bulk_ham",
            _("Suppress caching of bulk ham"),
            False,
            _(
     ...
     to prevent that traffic showing up in 'Review messages'."""
        ...
        (
            ...
            _("Maximum size of cached messages"),
            0,
            _(
                """Where message caching is enabled, this option suppresses caching
    ...
    "Headers": (
     ...
     should always be the subject of training."""
        ...
        (
            ...
            _("Augment score with logarithm"),
            False,
            _(
     ...
     "number of zeros" or "number of nines" next to the score value)."""
        ...
        (
            "include_score",
            _("Add probability (score) header"),
            False,
            _(
     ...
     and even instructive if you're a serious SpamBayes junkie."""
        ...
        (
            "score_header_name",
            _("Probability (score) header name"),
     ...
     a particular message was scored in a particular way."""
        ...
        (
            ...
            _("Evidence header name"),
            "X-Spambayes-Evidence",
            _(""""""),
            HEADER_NAME,
            RESTORE,
        ),
     ...
     should be identified in this fashion."""
            ...
            ((), _("ham"), _("spam"), _("unsure")),
            RESTORE,
        ),
        (
            "notate_subject",
            _("Classify in subject: header"),
            (),
            _(
...
"""
        ...
        (
            ...
            _("Allowed remote POP3 connections"),
            "localhost",
            _(
     ...
     used for classifications (i.e. results may be effected)."""
        ...
        (
            "use_ssl",
            "Connect via a secure socket layer",
            False,
    ...
    "smtpproxy": (
     ...
     specify the same number of ports as servers, separated by commas."""
        ...
        (
            "allow_remote_connections",
            _("Allowed remote SMTP connections"),
            "localhost",
            _(
     ...
     """
        ...
        (
            "ham_address",
            _("Train as ham address"),
            "spambayes_ham@localhost",
            _(
     ...
     a valid email address, like ham@nowhere.nothing."""
        ...
        (
            "spam_address",
            _("Train as spam address"),
            "spambayes_spam@localhost",
            _(
    ...
    "imap4proxy": (
     ...
     work, try 8143."""
        ...
        (
            "allow_remote_connections",
            _("Allowed remote IMAP4 connections"),
            "localhost",
            _(
    ...
    "html_ui": (
        ("port", _("Port"), 8880, _(""""""), PORT, RESTORE),
        (
            "launch_browser",
            _("Launch browser"),
            False,
     ...
     line overrides this option."""
        ...
        (
            "allow_remote_connections",
            _("Allowed remote UI connections"),
            "localhost",
            _(
     ...
     field to trust this only address."""
        ...
        (
            "display_headers",
            _("Headers to display in message review"),
            ("Subject", "From"),
            _(
     ...
     is to, or the date that the message was sent."""
        ...
        (
            ...
            _("Display date received in message review"),
            False,
            _(
                """When reviewing messages via the web user interface, you are
     ...
     """
        ...
        (
            "display_score",
            _("Display score in message review"),
            False,
            _(
                """When reviewing messages via the web user interface, you are
     ...
     message headers."""
        ...
        (
            "display_adv_find",
            _("Display the advanced find query"),
            False,
            _(
     ...
     is classified as ham?"""
            ...
            (_("ham"), _("spam"), _("discard"), _("defer")),
            RESTORE,
        ),
        (
            "default_spam_action",
            _("Default training for spam"),
            _("discard"),
            _(
                """When presented with the review list in the web interface,
     which button would you like checked by default when the message
    ...
    "imap": (
     ...
     False."""
        ...
        (
            "use_ssl",
            _("Connect via a secure socket layer"),
            False,
            _(
                """Use SSL to connect to the server. This allows spambayes to connect
     ...
     select a folder here."""
        ...
        (
            "ham_train_folders",
            _("Folders with mail to be trained as ham"),
            (),
            _(
     ...
     to train as ham."""
        ...
        (
            "spam_train_folders",
            _("Folders with mail to be trained as spam"),
            (),
            _(
                """Comma delimited list of folders that will be examined for messages
     to train as spam."""
        ...
        (
            ...
            _("Folder to move trained spam to"),
            "",
            _(
     ...
     folder."""
        ...
        (
            ...
            _("Folder to move trained ham to"),
            "",
            _(
    ...
    "ZODB": (
        ("zeo_addr", _(""), "", _(""""""), IMAP_ASTRING, DO_NOT_RESTORE),
        ("event_log_file", _(""), "", _(""""""), IMAP_ASTRING, RESTORE),
        ("folder_dir", _(""), "", _(""""""), PATH, DO_NOT_RESTORE),
        ("ham_folders", _(""), "", _(""""""), PATH, DO_NOT_RESTORE),
        ("spam_folders", _(""), "", _(""""""), PATH, DO_NOT_RESTORE),
        ("event_log_severity", _(""), 0, _(""""""), INTEGER, RESTORE),
        ("cache_size", _(""), 2000, _(""""""), INTEGER, RESTORE),
    ),
    "imapserver": (
        (
            "username",
    ...
    "globals": (
        ("verbose", _("Verbose"), False, _(""""""), BOOLEAN, RESTORE),
        (
            "dbm_type",
            _("Database storage type"),
            "best",
            _(
...
def load_options():
    ...
    if not optionsPathname:
        ...
        if sys.platform.startswith("win") and not os.path.isfile(
            optionsPathname
        ):
            ...
            try:
                ...
                print(
                    "NOTE: We can not locate an INI file "
                ...
                try:
                    ...
                    optionsPathname = os.path.join(
                        windowsUserDirectory, 'bayescustomize.ini'
                    )
